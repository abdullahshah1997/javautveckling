...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        while (true)
        {
            ...
            //Skapar ett felmeddelande vid för kort input.
            if(operation.length()<3&&!operation.equals("x"))
                System.out.println("Uttrycket är för kort");
...
//    System.out.println(calculateInput("     ") + " Ska ge ett felmeddelande om att tom sträng är ogiltigt");
//    System.out.println(calculateInput("10%12") + " Ska ge ett felmeddelande att giltig operator saknas");
